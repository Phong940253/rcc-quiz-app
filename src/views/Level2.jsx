        ...
        {round < level1.length ? (
          <>
            ...
            <form style={{ padding: "1rem 0" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <Button className={`${timer <= 8} && 'disabled`} maxWidth="20%">
                  5
                </Button>
                <Button className={`${timer <= 6} && 'disabled`}>4</Button>
                <Button className={`${timer <= 4} && 'disabled`}>3</Button>
                <Button className={`${timer <= 2} && 'disabled`}>2</Button>
                <Button className={`${timer <= 0} && 'disabled`}>1</Button>
                <Button
                  onClick={this.handleRestart}
                  style={{ display: timeOut ? "block" : "none" }}
                >
                  Click to Restart!
                </Button>
              </div>
